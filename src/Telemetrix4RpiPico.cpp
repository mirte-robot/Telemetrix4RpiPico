...
GPS_Sensor::GPS_Sensor(uint8_t settings[SENSORS_MAX_SETTINGS_A])
{
  ...
  // gpio_set_function(UART_TX_PIN, GPIO_FUNC_UART); // No need to send anything to the GPS receiver
...
{
  // TODO: is this fast enough? fifo is 32 bytes long, unknown speed of gps module
